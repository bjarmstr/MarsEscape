...
START_ECODE = {"error" : "0"}
EQUIPMENT = {"CDRA","SRA","CO2tank"} #tank required in tank equip names (to sort rate vs level)
ERROR_STREAMS = {"CDRA_error", "SRA_error"}

error_code = 0
RATE_CONSTANT = 10 #increase value to change level faster
...
def main():
    ...
    for item in EQUIPMENT:
        start_value = START_RATE if ("tank" not in item) else START_LEVEL
